...
- Auto-configuration, a servlet `KrynoxFilter`, and a `KrynoxWidget` embed helper.
- Configured with `krynox.*` properties.
- Visitor IP defaults to the servlet container's resolved peer; set
  `krynox.trusted-proxy-header` to read a forwarding header your edge overwrites.

[0.1.0]: https://github.com/krynox-security/plugin-spring-boot/releases/tag/v0.1.0
